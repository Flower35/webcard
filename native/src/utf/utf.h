...
/**
 * `UTF8String` is a reference to any
 * `utf8_string_t` structure.
 */
typedef struct utf8_string_t * UTF8String;

/**
 * `ConstUTF8String` is a reference to a CONSTANT
 * `utf8_string_t` structure.
 */
typedef struct utf8_string_t const * ConstUTF8String;
 ...
 * @param[out] byteArraySizePointer Pointer to a variable that will hold
...
/**
 * `UTF16String` is a reference to any
 * `utf16_string_t` structure.
 */
typedef struct utf16_string_t * UTF16String;

/**
 * `ConstUTF16String` is a reference to a CONSTANT
 * `utf16_string_t` structure.
 */
typedef struct utf16_string_t const * ConstUTF16String;

/**
 * Represents a UTF-16 formatted text.
 */
struct utf16_string_t
{
  /** Current length of the text (not including the NULL-terminator) */
  size_t length;
